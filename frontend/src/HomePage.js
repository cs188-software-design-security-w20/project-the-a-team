...
export default function HomePage() {
  ...
  const handleClickSave = async () => {
    ...
    for (const dependentUUID of deletedUUIDs.dependent) {
    ...
    for (const w2UUID of deletedUUIDs.w2) {
      w2[w2UUID] = null;
    }
    ...
    for (const form1099IntUUID of deletedUUIDs.int1099) {
    ...
    for (const form1099BUUID of deletedUUIDs.b1099) {
    ...
    for (const form1099DivUUID of deletedUUIDs.div1099) {
    ...
    deletedUUIDs.dependent = [];
    deletedUUIDs.w2 = [];
    deletedUUIDs.int1099 = [];
    deletedUUIDs.b1099 = [];
    deletedUUIDs.div1099 = [];
